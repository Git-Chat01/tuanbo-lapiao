...
其中 target_user / user_reason / vote_instruction 是三项彼此独立的原子能力：第 3 项只看有没有明确对到人，第 4 项只看有没有给用户侧价值，第 5 项只看票差和上票动作。不得把后一项的条件偷偷塞进前一项，让新人按提示补完后仍被隐藏门槛卡住。
...
3. target_user：只检查她有没有明确在对一个具体榜单用户或可识别的单个对象说话，不检查互动动作或上票动作。直接呼名、榜位或 @用户即可；"那凯哥……"、"凯哥啊……"、"我问下凯哥……"、"凯哥。你……"、点名后先说票差，都是自然呼语，不能因为语气、词序或句号降级。"凯哥，谢谢你刚才的小心心"既完成具体感谢，也确实在对凯哥说话，两项都可判 met。只有叙述"凯哥刚说……"、喊错现场对象或只喊"家人们"这类群体时才不能 met。若现场给了 targetUser，只检查是否明确在对这个人说话，喊别人不能替代；动作是否清楚只归第 5 项。
4. user_reason：只检查她有没有给用户侧的观看、互动、选择或回应价值，不检查评论动作或上票动作。接住"想看撒娇/返场/新舞/才艺"、说"我现在撒一个"、给好玩或有意思的体验、让对方选择/决定/当导演、承诺复活后兑现，任一明确成立即可 met；自然说法和标点不同但语义相同，结果必须一致。
