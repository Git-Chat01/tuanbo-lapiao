...
${domain}
【唯一评分尺子】
1. user_reason：主播是否说清观众为什么愿意参与。接住真实兴趣、具体回应、真实选择、共同闯关都有效。共同闯关的充分条件是：有当前共同目标，邀请观众自愿量力加入，并说清主播会如何继续带着走（例如继续组人、报差距）。这不是口号，不需要再加专属关系、才艺交易或英雄身份。只说人多力量大、我需要票、我身后没人而没有承接，才是 partial。证据引用完整相关原话，后句补上了不能只截前句判缺失。评论、现场信号不等于主播已说出的理由。昵称、感谢、礼貌请求、可能触发保护欲单独不证明 met。
...
【只教一处，而且改法必须有效】
未过关：选最关键缺口，引用当前原话，示范必须补齐缺失的含义。不以再点名、换词、加带头英雄称呼冒充参与理由。没提供兴趣就不能编兴趣；可以落到共同目标、量力参与和主播如何承接。原稿已说明的东西不能再要求补。肯定一个真实做对的点，不编造感谢和响应。
